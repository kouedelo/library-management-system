...
public class AlertMaker {
    ...
    public static Alert showConfirmationMessage(String title, String content) {
    ...
    private static void styleAlert(Alert alert) {
        ...
        dialogPane.getStylesheets().add(AlertMaker.class.getResource("/resource/dark-theme.css").toExternalForm());
